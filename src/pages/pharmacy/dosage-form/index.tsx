...
const DosageForm = () => {
  const [forms, setForms] = useState<DosageFormType[]>([])
          ...
          <tbody>
            ...
            {!loading &&
              ...
              filteredForms.map((form) => (
                <tr key={form.id} className="bg-[#DFDEDE] border-b border-gray-200">
                  <td className="px-6 py-4 font-medium text-gray-900">
                    {form.id}
                  </td>
                  <td className="px-6 py-4">{form.name}</td>
                  <td className="px-6 py-4">{form.code || '-'}</td>
                  ...
                  <td className="px-6 py-4 flex items-center gap-2">
                    {/* Edit */}
                    <Link
                      to={`${routePaths.DOSAGE_FORM}/${form.id}`}
