    ...
    <div className="flex flex-col gap-10 relative">
      ...
      <div className="flex justify-between items-center w-full border-b pb-3">
        ...
        <div className="flex items-center gap-5 min-w-100">
          ...
          <Button asLink to={routePaths.ADD_SUB_CATEGORY}>
            + Add Subcategory
          </Button>
        </div>
      </div>
            ...
            {!loading &&
              ...
              filteredSubcategories.map((sub) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{sub.parentName || '-'}</td>
                  <td className="px-6 py-4">
                    {sub.description?.length && sub.description.length > 45
                      ? `${sub.description.substring(0, 45)}...`
                      : sub.description || '-'}
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1">
                      <span
                        className={`w-[10px] h-[10px] rounded-full ${
                          sub.isActive ? 'bg-[#00cc00]' : 'bg-[#cc0000]'
                        }`}
                      />
